...
extern std::string REDSHOES_CHAIN_NAME;
extern std::string TUNNEL_ON_TEMPLATE_PATH;
extern std::string TUNNEL_OFF_TEMPLATE_PATH;
extern std::string TUNNEL_OFF_RENDERED_PATH;
extern std::string TUNNEL_ON_RENDERED_PATH;
#endif